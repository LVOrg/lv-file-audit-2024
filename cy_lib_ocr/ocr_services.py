...
class OCRService:
    ...
    def get_text_rect_from_image(self,image_path:str,lang="en")->typing.Iterable[typing.Tuple[float,float,float,float]]:
    ...
    def get_text_from_pdf(self, pdf_file)->typing.Union[str,None]:
        file_iter: typing.Iterable[str] = self.pdf_service.image_extract(pdf_file_path=pdf_file, output_dir=self.tmp_output_dir)
        contents  = []
        for x in file_iter:
