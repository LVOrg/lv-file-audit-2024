...
class Process:
    ...
    def on_receive_msg(self, msg_info: MessageInfo, msg_broker: MessageService):
        ...
        server_file = config.private_web_api+"/api/"+msg_info.AppName+"/file/"+msg_info.Data['FullFileNameLower']
        ...
        if hasattr(msg_info.Data,"local_share_id"):
            local_share_id = msg_info.Data.msg_info.Data
        if local_share_id:
        ...
        if isinstance(image_data,numpy.ndarray):
            ...
            self.local_api_service.send_file(
                ...
                rel_server_path = msg_info.Data['StoragePath'].split("://")[1]+"/image_file_name"
